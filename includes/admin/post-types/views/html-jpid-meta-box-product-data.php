 ...
 */
?>
<?php wp_nonce_field( JPID_Admin_Product_Edit::NONCE_ACTION, JPID_Admin_Product_Edit::NONCE_NAME ); ?>
<div class="jpid-field-container">
  <div class="jpid-label-wrapper">
    <label for="jpid_product_price" class="jpid-label-wrapper__label">
      <?php esc_html_e( 'Product Price (Rp)', 'jpid' ); ?>
    </label>
  </div>
...
<div class="jpid-field-container">
  ...
  <div class="jpid-field-wrapper">
    ...
    <?php include_once JPID_PLUGIN_DIR . 'includes/admin/post-types/views/html-jpid-meta-box-product-data-category-field.php'; ?>
  </div>
</div>
