...
class JPID_Admin_Product_Category {
  ...
  private function setup_hooks() {
    add_action( 'jpid_product_category_add_form_fields', array( $this, 'add_term_meta_fields' ) );
    add_action( 'jpid_product_category_edit_form_fields', array( $this, 'edit_term_meta_fields' ) );
    add_action( 'created_jpid_product_category', array( $this, 'save_term_meta_fields' ), 10, 2 );
    add_action( 'edited_jpid_product_category', array( $this, 'save_term_meta_fields' ), 10, 2 );
    add_action( 'manage_edit-jpid_product_category_columns', array( $this, 'add_term_meta_columns' ) );
    add_action( 'manage_jpid_product_category_custom_column', array( $this, 'add_term_meta_columns_content' ), 10, 3 );
    add_action( 'manage_edit-jpid_product_category_sortable_columns', array( $this, 'set_term_meta_sortable_columns' ) );
    add_action( 'pre_get_terms', array( $this, 'set_term_meta_custom_sorting' ) );
    add_action( 'quick_edit_custom_box', array( $this, 'add_term_meta_quick_edit' ) );
    add_action( 'admin_head-edit-tags.php', array( $this, 'remove_fields' ) );
    add_action( 'admin_head-term.php', array( $this, 'remove_fields' ) );
  }
  ...
  public function add_term_meta_fields() {
    include_once JPID_PLUGIN_DIR . 'includes/admin/post-types/views/html-jpid-meta-field-add-product-category.php';
  }
  ...
  public function edit_term_meta_fields( $term ) {
    include_once JPID_PLUGIN_DIR . 'includes/admin/post-types/views/html-jpid-meta-field-edit-product-category.php';
  }
  ...
  public function add_term_meta_quick_edit( $column_name ) {
    ...
    include_once JPID_PLUGIN_DIR . 'includes/admin/post-types/views/html-jpid-quick-edit-product-category.php';
  }
