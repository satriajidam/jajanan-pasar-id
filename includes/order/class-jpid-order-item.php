...
/**
 * Factory class for managing order item.
 *
 * @since      1.0.0
...
class JPID_Order_Item {

  const SNACK_BOX = 'snack-box';
  ...
  /**
   * Create order item object based on provided item id and type.
   *
   ...
   */
  public static function create( $item_id = 0, $item_type = '' ) {
